...
!   _temp_618 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-32]
!   Move address of _temp_618 [p ] into _temp_619
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   Data Move: *_temp_619 = 1  (sizeInBytes=4)
	mov	1,r1
	load	[r14+-28],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_635 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-48]
!   Move address of _temp_635 [p ] into _temp_636
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-44]
!   Data Move: *_temp_636 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-44],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   Data Move: _temp_663 = *_temp_665  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-76]
!   if _temp_663 != 1 then goto _Label_660		(int)
	load	[r14+-76],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_660
...
!   _temp_668 = _temp_669 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-56]
!   Move address of _temp_667 [_temp_668 ] into _temp_670
!     make sure index expr is >= 0
	load	[r14+-56],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_666 = *_temp_670  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-64]
!   if _temp_666 == 2 then goto _Label_660		(int)
	load	[r14+-64],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_660
...
!   _temp_673 = _temp_674 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-36]
!   Move address of _temp_672 [_temp_673 ] into _temp_675
!     make sure index expr is >= 0
	load	[r14+-36],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_671 = *_temp_675  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-44]
!   if _temp_671 == 2 then goto _Label_660		(int)
	load	[r14+-44],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_660
...
!   _temp_705 = 4		(4 bytes)
	...
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: p = _temp_704  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-44]
_Label_700:
!   Perform the FOR-LOOP termination test
!   if p > _temp_705 then goto _Label_703		
	load	[r14+-44],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
