...
! Make sure _P_Thread_ has hash value 0xd98e6cc5 (decimal -644977467)
	...
	cmp	r1,0
	bne	_Label_59
! Make sure _P_Synch_ has hash value 0x48d0d7ce (decimal 1221646286)
	set	_packageName,r2
	set	0x48d0d7ce,r3
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: monLock = zeros  (sizeInBytes=24)
	load	[r14+8],r4
	add	r4,28,r4
	store	r0,[r4]
	store	r0,[r4+4]
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   Data Move: _temp_649 = *_temp_651  (sizeInBytes=4)
	load	[r14+-28],r1
	load	[r1],r1
	store	r1,[r14+-36]
!   if _temp_649 != 1 then goto _Label_648		(int)
	load	[r14+-36],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_648
...
!   _temp_672 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-48]
!   Move address of _temp_672 [p ] into _temp_673
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-44]
!   Data Move: *_temp_673 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-44],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   if intIsZero (_temp_680) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Prepare Argument: offset=12  value=_temp_678  sizeInBytes=4
	load	[r14+-24],r1
	store	r1,[r15+4]
!   Send message Test
	load	[r14+-16],r1
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-76]
!   Data Move: _temp_700 = *_temp_702  (sizeInBytes=4)
	load	[r14+-76],r1
	load	[r1],r1
	store	r1,[r14+-84]
!   if _temp_700 != 1 then goto _Label_697		(int)
	load	[r14+-84],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_697
...
!   _temp_705 = _temp_706 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-64]
!   Move address of _temp_704 [_temp_705 ] into _temp_707
!     make sure index expr is >= 0
	load	[r14+-64],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-56]
!   Data Move: _temp_703 = *_temp_707  (sizeInBytes=4)
	load	[r14+-56],r1
	load	[r1],r1
	store	r1,[r14+-72]
!   if _temp_703 == 2 then goto _Label_697		(int)
	load	[r14+-72],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_697
...
!   _temp_710 = _temp_711 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-44]
!   Move address of _temp_709 [_temp_710 ] into _temp_712
!     make sure index expr is >= 0
	load	[r14+-44],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-36]
!   Data Move: _temp_708 = *_temp_712  (sizeInBytes=4)
	load	[r14+-36],r1
	load	[r1],r1
	store	r1,[r14+-52]
!   if _temp_708 == 2 then goto _Label_697		(int)
	load	[r14+-52],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_697
...
!   _temp_713 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-32]
!   Move address of _temp_713 [p ] into _temp_714
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   Data Move: *_temp_714 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-28],r2
	store	r1,[r2]
! SEND STATEMENT...
