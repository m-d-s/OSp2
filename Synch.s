...
_StringConst_5:
	.word	45			! length
	.ascii	"Unlock attempt made by non lock owning thread"
	.align
_StringConst_4:
	.word	18			! length
	.ascii	"Deadlock Detected!"
	.align
_StringConst_3:
	.word	51			! length
...
_CheckVersion_P_Synch_:
	...
	set	0x48d0d7ce,r4		! myHashVal = 1221646286
	cmp	r3,r4
	be	_Label_9
	set	_CVMess1,r1
	call	_putString
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   hasLock = _P_Thread_currentThread		(4 bytes)
	set	_P_Thread_currentThread,r1
	load	[r1],r1
	load	[r14+8],r2
	store	r1,[r2+8]
...
!   Send message IsHeldByCurrentThread
	...
	add	r2,16,r2
	call	r2
!   Retrieve Result: targetName=_temp_73  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-9]
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (t) then goto _Label_78
	load	[r14+-40],r1
	cmp	r1,r0
	be	_Label_78
!	jmp	_Label_77
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if _P_Thread_currentThread != hasLock then goto _Label_92		(int)
	set	_P_Thread_currentThread,r1
	load	[r1],r1
	load	[r14+8],r2
	load	[r2+8],r2
